...
const SOCIAL_LINKS = [
  ...
  { icon: Instagram, href: "https://www.instagram.com/ravirajsinhgohil._", label: "Instagram" },
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1 text-center lg:text-left">
              ...
              <h1 className="text-5xl md:text-display font-bold text-foreground mb-4 leading-tight">
                Hi, I'm <span className="text-gradient-gold">Ravirajsinh Gohil</span>
              </h1>

              <h2 className="text-xl md:text-2xl text-muted-foreground mb-4 font-medium">
                Web Developer & <span className="text-primary">AI Designer</span>
              </h2>
